...
# koerperselbstwert in abhaengigkeit des clusters angst vor Leistungsversagen vs generelle Ängstlichkeit
# note that id's are not integers - id_nummer is decimal if at least NA in row
subset = subset(data, select = c(sp_angst_lv_1, t_angst_1, Nettohoffnung_1, Nettohoffnung_3, id_nummer, gruppe_3))
...
write.csv(sub, './cluster-nettohoffnung.csv')
